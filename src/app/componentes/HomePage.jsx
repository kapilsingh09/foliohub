...
const HeroSection = () => {
  ...
  return (
    <div className="h-auto md:h-[40rem] min-h-screen w-full bg-black text-white flex flex-col md:flex-row rounded-md relative overflow-hidden mx-auto py-10 md:py-0">
      {/* Left Side */}
      <div className="w-full md:w-[65%] mt-10 flex pl-4 sm:pl-6 md:pl-10 flex-col items-center justify-center p-4 sm:p-6 relative z-10 text-center md:text-left">
        <Spotlight className="-top-40 left-0 md:-top-35 md:left-20" fill="white" />

        <motion.h1
          className="mt-20 md:mt-0 text-3xl sm:text-4xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400"
        ...
        <div className="w-full space-y-6 ">
          <motion.p
            className="font-normal text-sm sm:text-base md:text-xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 mx-auto md:mx-0 max-w-[90%] sm:max-w-[80%] md:max-w-[70%] mt-6 sm:mt-8 p-2 text-center md:text-left tracking-wide leading-relaxed flex-wrap"
          ...
          >
            <span>
              ...
              <motion.span
                ...
                className={`  py-1.5 px-2 rounded-xl font-normal text-sm sm:text-base md:text-xl tracking-wide ${dynamicWords[index].color}`}
